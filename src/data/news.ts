const news = [
  {
    ...
    body: `
      ...
      1.⁠ ⁠Top BUMD 2025 - Star 4
      2.⁠ ⁠Top Pembina BUMD 2025 yang dianugerahka kepada Bupati Wonosobo Bapak Afif Nurhidayat, S.Ag.,
      3.⁠ ⁠Top CEO BUMD 2025 yang diberikan kepada Ibu Galih Pambajeng, S.Ak., selaku Direktur Operasional PT BPR Bank Wonosobo (Perseroda).

      Pencapaian ini menjadi bukti nyata atas kinerja unggul, inovasi dan komitmen PT BPR Bank Wonosobo (Perseroda) dalam membangun kemandirian ekonomi daerah serta meningkatkan pelayanan kepada masyarakat. Penilaian dalam ajang BUMD Awards ini dilakukan secara ketat melalui proses seleksi, presentasi, dan wawancara oleh dewan juri independen yang terdiri dari pakar bisnis, ekonomi, dan pemerintah.

      Acara penganugerahan ini turut dihadiri oleh Wakil Bupati Wonosobo, Bapak Amir Husein, yang memberikan dukungan penuh kepada seluruh jajaran manajemen dan insan PT BPR Bank Wonosobo (Perseroda).

      Dalam kesempatan ini Direktur Operasional PT BPR Bank Wonosobo (Perseroda) Ibu Galih Pambajeng, S.Ak., menyampaiakan rasa syukur dan terima kasih atas penghargaan yang diraih. “Penghargaan ini kami dedikasikan untuk seluruh masyarakat Wonosobo, nasabah, dan seluruh tim PT BPR Bank Wonosobo yang telah bekerja keras. Ini menjadi motivasi kami untuk terus tumbuh, berinovasi dan memberikan pelayanan yang lebih baik lagi di masa mendatang,” ujar beliau.
  ...
  },
  {
    ...
    body: `
      ...
      Kegiatan dibuka secara resmi oleh Bupati Wonosobo, Bapak Afif Nurhidayat, yang dalam sambutannya mengapresiasi komitmen Bank Wonosobo dalam membangun SDM yang tidak hanya kompeten, tetapi juga berintegritas dan cinta tanah air.

      Dengan mengusung tema “Pembentukan Character Building, Integritas, dan Jiwa Korsa Karyawan Bank Wonosobo”, kegiatan ini diikuti oleh 59 peserta, yang terdiri dari karyawan dan karyawati Bank Wonosobo. Para peserta mengikuti berbagai materi dan kegiatan yang dirancang untuk memperkuat nilai-nilai kebangsaan, kekompakan tim, serta ketahanan mental dan fisik.

      Acara ini mendapat dukungan penuh dari Kodim 0707 Wonosobo. Komandan Kodim Wonosobo juga memberikan dukungan langsung demi kelancaran kegiatan serta mendorong semangat nasionalisme yang tinggi di kalangan peserta.

      Menambah bobot kegiatan, Direktur Operasional PT BPR Bank Wonosobo (Perseroda), Galih Pambajeng, S.Ak., turut hadir dan membawakan materi motivasi serta penguatan nilai-nilai integritas dan loyalitas kepada para peserta. Dalam penyampaiannya, beliau menekankan pentingnya sinergi antara profesionalisme kerja dengan semangat kebangsaan dalam menjalankan tugas sehari-hari sebagai pelayan publik di sektor perbankan daerah.
